...
int main() {
    ...
    printf("A char is %ld bytes long in decimal\n", sizeof(char));          
    printf("A short is %ld bytes long in decimal\n", sizeof(short));
    printf("An int is %ld bytes long in decimal\n", sizeof(int));
    printf("A long is %ld bytes long in decimal\n", sizeof(long));
    printf("A float is %ld bytes long in decimal\n", sizeof(float));            // these are the lengths of different variable types
    printf("A double is %ld bytes long in decimal\n", sizeof(double));

    printf("A char is %lx bytes long in hex\n", sizeof(char));          
    printf("A short is %lx bytes long in hex\n", sizeof(short));
    printf("An int is %lx bytes long in hex\n", sizeof(int));
    printf("A long is %lx bytes long in hex\n", sizeof(long));
    printf("A float is %lx bytes long in hex\n", sizeof(float));
    printf("A double is %lx bytes long in hex\n", sizeof(double));
