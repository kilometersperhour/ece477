printf("A char is %d bits long in decimal", char);          
printf("A short is %d bits long in decimal", short);
printf("An int is %d bits long in decimal", int);
printf("A long is %d bits long in decimal", long);
printf("A float is %d bits long in decimal", float);
